                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">EResults Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<tr>
                                                <th scope="row" colspan="2">Download Result</th>           
                                                            <td><button><a href="download-result.php">Download </a> </b></td>
                                                             </tr>

 <?php } else { ?>     
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Notice! Your result not declare yet </strong>
 <?php }
?>
                                        </div>
 <?php 
...
<strong> Oh Wrong Details!!</strong>
<?php
echo htmlentities("Invalid Roll Id or 10th Marks");
 }
?>
                                        </div>
