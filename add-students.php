...
<div class="form-group">
<label for="text" class="col-sm-2 control-label">10th Results Percentage</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="name" placeholder="Enter 10th Result %" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="radio" name="gender" value="Male" required="required" checked=""> Male <input type="radio" name="gender" value="Female" required="required"> Female <input type="radio" name="gender" value="Other" required="required"> Others
</div>
</div>
